...
public class CodeGenVisitor implements ASTVisitor, Opcodes {
    ...
    private final SymbolTable<Label> procedureSymbolTable;
    ...
    public Object visitProgram(Program program, Object arg) throws PLPException {
        ...
        return Arrays.asList(new CodeGenUtils.GenClass("edu.ufl.cise.plpfa22.prog", classWriter.toByteArray()));
    }
    ...
    public Object visitBlock(Block block, Object arg) throws PLPException {
        ...
        for (final ProcDec dec : nullSafeList(procedureDecs)) {
            ...
            procedureSymbolTable.insert(name, new Label());
        }
        for (final ProcDec dec : nullSafeList(procedureDecs)) {
            dec.visit(this, arg);
        }
    ...
    public Object visitStatementCall(StatementCall statementCall, Object arg) throws PLPException {
        ...
        final MethodVisitor mv = (MethodVisitor) arg;
        mv.visitMethodInsn(INVOKEVIRTUAL, fullyQualifiedClassName, name, "V", false);
        return null;
    }
    ...
    public Object visitProcedure(ProcDec procDec, Object arg) throws PLPException {
        ...
        final Label returnLabel = (Label) args.get(1);
        new Label()
        mv.visitVarInsn();
